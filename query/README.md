...
This directory is reserved for experimental analytics flows and Model Context Protocol (MCP) recipes that consume the Austender Parquet lake.

## Current Status
- No executable code is shipped yet; use this space to document prototype SQL/Arrow queries, MCP manifests, or notebook links that complement the main collector/server stack.
